...
class vehicle(Order) :
    ...
    def __init__(self ,vehicle_model ,origin ,destination ,date_time ,Normal_sits ,vip_sits = None, *vip_sits_count) :
        ...
        self._origin = origin
        self._destination = destination
        self._vip_sits_counter = vip_sits_count
        self._date_time = date_time
    ...
    def _sits_calculator(self,shifters) :
        ...
        if int(shifters[1]) > 0 :
            vip_sits = self._vip_sits_counter
